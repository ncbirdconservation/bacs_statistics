...
bacs <- na.omit(subset(habq_2factor, ,select=c(POINTID, PASS, ACTIVE, JULIAN, BA, FIRE, WIRE, FORB, WOOD, BARE, MIDHARD, HABQI, TMIDMIN, OBS)))	#only those sites surveyed, and with habitat quality index
